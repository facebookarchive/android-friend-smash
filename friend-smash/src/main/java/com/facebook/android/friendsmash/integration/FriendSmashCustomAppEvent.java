...
/**
 * This class holds constants with the custom App Event name and its parameter that are logged in
 * the game. For more details on App Events see: https://developers.facebook.com/docs/app-events
 */
